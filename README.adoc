...
:uri-public-repo: https://github.com/AjuntamentdeBarcelona/innovative-procurement-bcn-ca
//
// MANDATORY. Exactly the same value you give to key "name" in file antora.yml.
:component-name: ca/innovative-procurement
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Compra pública innovadora
//
...
:_summary: Eina fonamental per obtenir solucions que s’ajustin molt més a les demandes reals de la societat i ajudar a les empreses a ser més competitives
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: estàndards digitals ètics, drets digitals, Barcelona, ajuntament, compra pública innovadora
//
